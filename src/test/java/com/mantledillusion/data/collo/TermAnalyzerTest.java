...
public class TermAnalyzerTest {
	...
	@Before
	public void before() {
		this.analyzer = TermAnalyzer
				.forTerm(Terms.FULLNAME, KeywordAnalyzer.
						forKeyword(Keywords.FORENAME).
						andKeyword(Keywords.UNDESIRABLE_NUMBER, KeywordOccurrence.EXCLUSIVE).
						andKeyword(Keywords.LASTNAME).build())
				.andTerm(Terms.FULLADDRESS, KeywordAnalyzer.
						...
						andKeyword(Keywords.CITY).build())
				.build();
	}
